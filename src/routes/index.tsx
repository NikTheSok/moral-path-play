...
export const Route = createFileRoute("/")({
  head: () => ({
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Press+Start+2P&family=VT323&family=Orbitron:wght@400;600;800&family=Pixelify+Sans:wght@400..700&display=swap" },
    ],
  }),
  component: Index,
});
